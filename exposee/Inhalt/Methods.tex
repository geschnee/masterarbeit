...
\begin{figure}
     \[R(s_t,a_t) = c_1 \cdot DistanceReward(s_t,a_t) + c_2 \cdot VelocityReward(s_t, a_t) + c_3 \cdot EventReward(s_t, a_t)\]

     \[DistanceReward(s_t,a_t) = \Delta distance(agent, nextGoal)\]
...
% TODO figure for n second bootstrapping?
...
\begin{figure}
     \centering
     \subfigure[Standard Lighting Agent POV]{\includegraphics[width=0.25\textwidth]{Bilder/light_setting_pov_standard.png}}\qquad
     \subfigure[Standard Lighting Arena]{\includegraphics[width=0.5\textwidth]{Bilder/light_setting_arena_standard.png}}
     \subfigure[Reduced Lighting Agent POV]{\includegraphics[width=0.25\textwidth]{Bilder/light_setting_pov_reduced_lighting.png}}\qquad
     \subfigure[Reduced Lighting Arena]{\includegraphics[width=0.5\textwidth]{Bilder/light_setting_arena_reduced_lighting.png}}
     \subfigure[Increased Lighting Agent POV]{\includegraphics[width=0.25\textwidth]{Bilder/light_setting_pov_increased_lighting.png}}\qquad
