...
\begin{description}
     ...
     \item[Rescaling pixel values to between 0 and 1] can help the neural network learn quicker %TODO true? why was this done?
\end{description}
