...
% --------------------------------------------------------------------------
\newcommand{\titel}{Investigating implementation details of reinforcement learning for self driving agents}
\newcommand{\art}{Expose Masterarbeit} %Bachelorarbeit
\newcommand{\ort}{Leipzig}
\newcommand{\hochschule}{Universität Leipzig}
\newcommand{\fachgebiet}{Abteilung Datenbanken}
\newcommand{\fakultaet}{Faulty of Mathematics and Computer Science}
