...
\begin{figure}
    \centering
    \subfigure{\includegraphics[width=0.4\textwidth]{Bilder/evaluation_hard.png}}\qquad
    \subfigure{\includegraphics[width=0.4\textwidth]{Bilder/agent_image_from_unity.png}}\\
