...
\newcommand{\spawnOrientation}[1]{\includegraphics[width=0.3\textwidth]{Bilder/latex_images/#1.png}}
\begin{figure}
    \centering
...
\begin{figure}
    ...
    \label{fig:jetbots}
\end{figure} % TODO angle the wheels of the FourWheelJetBot in the image
...
% TODO move this table to the event reward
