...
\begin{figure}[h]
    \centering
    \subfigure[easyBlueFirst]{\includegraphics[width=0.3\textwidth]{Bilder/image_printer_images/tracks/MapType.easyBlueFirst.png}}\qquad
    \subfigure[easyRedFirst]{\includegraphics[width=0.3\textwidth]{Bilder/image_printer_images/tracks/MapType.easyRedFirst.png}}\\
    \subfigure[mediumBlueFirstLeft]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.mediumBlueFirstLeft.png}}\qquad
    \subfigure[mediumBlueFirstRight]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.mediumBlueFirstRight.png}}\qquad
    \subfigure[mediumRedFirstLeft]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.mediumRedFirstLeft.png}}\qquad
    \subfigure[mediumRedFirstRight]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.mediumRedFirstRight.png}}\\
    \subfigure[hardBlueFirstLeft]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.hardBlueFirstLeft.png}}\qquad
    \subfigure[hardBlueFirstRight]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.hardBlueFirstRight.png}}\qquad
    \subfigure[hardRedFirstLeft]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.hardRedFirstLeft.png}}\qquad
    \subfigure[hardRedFirstRight]{\includegraphics[width=0.2\textwidth]{Bilder/image_printer_images/tracks/MapType.hardRedFirstRight.png}}\\
    \caption{All tracks}
...
\begin{pseudocode}{Generate Map and Rotation Combinations}{ }
    ...
    \FOR i \GETS 0 \TO n\_eval\_episodes - 1 \DO
    \BEGIN
    tracks.\CALL{append}{\CALL{GetTrack}{i \mod \CALL{len}{track\_numbers}}}\\
    \END\\
