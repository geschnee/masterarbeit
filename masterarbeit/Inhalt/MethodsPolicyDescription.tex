...
\newcommand{\unityImg}[1]{\includegraphics[width=1\linewidth]{Bilder/latex_images/preprocessingSteps/fixedSpawnPoint_hardBlueFirstLeft_#1_image_from_unity.png}}
\newcommand{\downsampledImg}[1]{\includegraphics[width=1\linewidth]{Bilder/latex_images/preprocessingSteps/fixedSpawnPoint_hardBlueFirstLeft_#1_downsampled.png}}
\newcommand{\grayscaleImg}[1]{\includegraphics[width=1\linewidth]{Bilder/latex_images/preprocessingSteps/fixedSpawnPoint_hardBlueFirstLeft_#1_grayscale.png}}
\newcommand{\equalizedImg}[1]{\includegraphics[width=1\linewidth]{Bilder/latex_images/preprocessingSteps/fixedSpawnPoint_hardBlueFirstLeft_#1_equalized.png}}
\newcommand{\finalImg}[1]{\includegraphics[width=1\linewidth]{Bilder/latex_images/preprocessingSteps/fixedSpawnPoint_hardBlueFirstLeft_#1.png}}
\begin{table}
...
\begin{figure}
    \centering
    \subfigure[Original Image]{\includegraphics[width=0.3\textwidth]{Bilder/latex_images/histogram/original_image.png}}
    \subfigure[Equalized Image Image]{\includegraphics[width=0.3\textwidth]{Bilder/latex_images/histogram/equalized_image.png}}\\
    \subfigure[Original Image Histogram]{\includegraphics[width=0.3\textwidth]{Bilder/latex_images/histogram/original_histogram.png}}
    \subfigure[Equalized Image Histogram]{\includegraphics[width=0.3\textwidth]{Bilder/latex_images/histogram/equalized_histogram.png}}\\
...
\newcommand{\includePreprocessedImage}[1]{\includegraphics[width=0.15\textwidth]{Bilder/latex_images/memory_mechanism/preprocessed_image_step_#1.png}}
...
neural network + action distribution
...
\begin{figure}
    ...
    \begin{tabular}{|| c | p{0.25\linewidth} | p{0.4\linewidth} ||} 
        ...
        %\multirow{1}{*}{Action Head} & Fully connected Layer & 2 output neurons, (2 x 512) matrix \\
...
%3 conv layers feature extractor:
%- 32 filters mit (frame\_stacking, 8, 8)
%- 64 filters mit (32, 4, 4)
%- 64 filters mit (64, 3, 3)
%1 fully connected layer mit 512 units
%- fully mit 512 units
