...
The neural network has produces two outputs, the action distribution and a value estimate. The outputs are produced by sections of the network called the action and value head. The action head produces the action distribution. The value head produces the estimate of the state's value. 

The action and value head share the first part of the neural network. They are built on top of the feature extractor. The full structure is shown in \ref{fig:network_structure}.
