...
\include{Inhalt/MethodsRewardFunctionsCapabilityCheck}



\include{Inhalt/Experiments}

\include{Inhalt/ExperimentsMixedTraining}

\include{Inhalt/ExperimentsPhysicalRobot}

\include{Inhalt/ExperimentsAndEvaluation}
