...
\newcommand\questionOne{Is it possible to train an autonomous driving agent consisting of a convolutional neural network with end-to-end reinforcement learning to reliably solve the tracks of all difficulty levels?}
\newcommand\questionTwo{Is it possible to use an end-to-end trained CNN to make the agent robust to changing light conditions?}
\newcommand\questionThree{Is it possible to use a neural network that can be transfered to a physical robot?}
