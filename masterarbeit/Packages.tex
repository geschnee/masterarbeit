...
\usepackage{multirow} % für meine Multirow tabellen (env parameter trainingLightSetting)
...
%\usepackage[english]{babel} % I previously used this but there is no biliography
\usepackage[english, ngerman]{babel}
...
\usepackage{tikz} % für die Zeitstrahl grafiken
